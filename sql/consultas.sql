...
-- 1) Obtener el nombre y apellido de todos los guitarristas estadounidenses
	...
	where p.dni = ti.dni and p.pais_nacimiento = ti.pais_origen and i.id = ti.instrumento and i.nombre = 'Guitarra eléctrica' and p.pais_nacimiento = 'Estados Unidos'
...
-- 2) Obtener el nombre de todos los artistas que hayan lanzado albumes bajo Roadrunner Records, junto con dichos albumes
	...
	from Artista as ar, Album as al, Lanza as l, SelloDiscografico as sd
	where ar.id = l.artista and al.id = l.album and sd.id = al.sello and sd.nombre = 'Roadrunner Records'
